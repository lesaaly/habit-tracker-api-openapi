  ...
  static collectRequestParams(request) {
    ...
    if (request.openapi.schema.requestBody !== null) {
      ...
      if (content['application/json'] !== undefined) {
        ...
        // express-openapi-validator может класть тело в request.openapi.requestBody
        const body = (request.openapi && request.openapi.requestBody !== undefined)
          ? request.openapi.requestBody
          : request.body;
        requestParams[requestBodyName] = body;
